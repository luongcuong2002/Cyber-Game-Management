        ...
        switch (e.getActionCommand()) {
            case "btnPrePaidLogin": {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    ...
                    computer.turnOnComputer(new User(computer.getComputerName(), amount, "Guest", true), parentView);
                }
                break;
            }
            ...
            case "btnTopup": {
                ...
                User user = computer.getUserUsing();
            ...
            case "btnNoteOfUser": {
                JTextField edtNote = new JTextField();
                final JComponent[] inputs = new JComponent[]{
                    new JLabel("Ghi chú"), edtNote,};
                int result = JOptionPane.showConfirmDialog(null, inputs, "Ghi chú", JOptionPane.PLAIN_MESSAGE);
                if (result == JOptionPane.OK_OPTION) {
                    computer.setNote(edtNote.getText().trim());
                    parentView.refreshTable();
                }
                break;
            }
